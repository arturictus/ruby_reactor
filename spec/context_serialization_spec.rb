...
RSpec.describe RubyReactor::ContextSerializer do
  ...
  describe '.serialize' do
    ...
    it 'raises error for context too large' do
      ...
      }.to raise_error(RubyReactor::Error::ContextTooLargeError)
    end
  end
  ...
  describe '.deserialize' do
    ...
    it 'raises error for invalid JSON' do
      ...
      }.to raise_error(RubyReactor::Error::DeserializationError)
    end
    ...
    it 'raises error for unsupported schema version' do
      ...
      }.to raise_error(RubyReactor::Error::SchemaVersionError)
    end
  end
