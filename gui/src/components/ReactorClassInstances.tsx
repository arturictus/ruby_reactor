    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-start gap-4">
          <Link to="/" className="p-2 hover:bg-white/5 rounded-full text-slate-400 hover:text-white transition-colors mt-0.5">
            <ChevronLeft className="w-5 h-5" />
          </Link>
          <div>
            <h1 className="text-2xl font-bold text-white tracking-tight">{className}</h1>
            <p className="text-slate-400 text-sm mt-1">
              {classReactors?.length ?? 0} execution{classReactors?.length === 1 ? '' : 's'}
            </p>
          </div>
        </div>
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-24 text-center">
                      <div className="flex flex-col items-center gap-3 text-slate-500">
                        ...
                        <p>No executions found for this reactor class.</p>
                      </div>
                    </td>
                  </tr>
                )}
